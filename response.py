...
def get_response(user_input: str) -> str:
    ...
    if lowered == '':
        return '** # __อย่าเอ๋อ__ **'
    elif 'ดีคับพี่' in lowered:
        return '**ดีคับไอสลัม**'
    elif lowered == 'ควย':
        return choice(highzy1)
    elif lowered in 'เหมือนพ่อมึงไง':
        return '**พ่อมึงนั่นแหละ ไอเอ๋อ**'
